// bot/tradingBot.js - Bot de trading optimisé
...
export class TradingBot extends EventEmitter {
  ...
  async _performHealthCheck() {
    try {
      ...
      // Vérification de la latence de l'API
  ...
  async start() {
    ...
    try {
      ...
      this.notificationService.notify({
        type: 'system',
        title: 'Bot Démarré',
        message: `Bot de trading démarré avec succès à ${new Date().toLocaleString()}`,
        priority: 'medium'
      });
  ...
  async stop() {
    ...
    try {
      ...
      this.notificationService.notify({
        type: 'system',
        title: 'Bot Arrêté',
        message: `Bot de trading arrêté après ${uptime} d'exécution`,
        priority: 'medium'
      });
    ...
    try {
      ...
      if (wasRunning) {
        ...
        this.notificationService.notify({
          type: 'system',
          title: 'Bot Redémarré',
          message: `Le bot de trading a été redémarré avec ${currentPositions.length} positions ouvertes`,
          priority: 'high'
        });
  ...
  async pause() {
    ...
    try {
      ...
      this.notificationService.notify({
        ...
        message: 'Les opérations de trading ont été mises en pause',
        priority: 'medium'
      });
  ...
  async resume() {
    ...
    try {
      ...
      this.notificationService.notify({
        type: 'system',
        title: 'Trading Repris',
        message: 'Les opérations de trading ont été reprises',
        priority: 'medium'
      });
